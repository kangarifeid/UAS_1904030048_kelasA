  ...
  <section class="page-section" id="services">
    <div class="container justify-content-center">
      ...
      <ul class="list-group">
        ...
        <li class="list-group-item">Harga Buku : <?= $buku['harga_buku']; ?></li>
        <li class="list-group-item">Stok Buku : <?= $buku['stok_buku']; ?></li>
        <li class="list-group-item">
          <a href="edit_buku.php?id=<?= $buku['id']; ?>" class="btn btn-warning" role="button">Edit</a> |
